...
{				
	...
	if (d) {				
		...
		if(z==0){
			...
			document.getElementById('lien'+n).innerHTML="Cacher";
			document.getElementById('lien'+n).style.background='url("images/plierDeplier_moins.gif") no-repeat top right';
			z = 1;
			y = n;
		}else if((z==1)&&(y==n)){
			d.style.display="none";
			document.getElementById('lien'+n).innerHTML="Voir tout l'échange";
